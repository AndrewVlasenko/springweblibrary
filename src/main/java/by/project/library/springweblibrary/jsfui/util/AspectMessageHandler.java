package by.project.library.springweblibrary.jsfui.util;
...
public class AspectMessageHandler {
    ...
    @Around("execution(* by.project.library.springweblibrary.jsfui.controller.*.deleteAction(..))")
    ...
    @Around("execution(* by.project.library.springweblibrary.dao.*.save(..))")
